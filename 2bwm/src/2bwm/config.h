...
static const char *ignore_names[] = {"polybar", "xclock","Polybar","synapse"};
///--Menus and Programs---///
static const char *menucmd[]   = { "synapse", NULL };
///--Custom foo---///
...
static key keys[] = {
    ...
    // Move a window
    {  MOD |ALT,          XK_Up,         movestep,          {.i=TWOBWM_MOVE_UP}},
    {  MOD |ALT,          XK_Down,       movestep,          {.i=TWOBWM_MOVE_DOWN}},
    {  MOD |ALT,          XK_Right,      movestep,          {.i=TWOBWM_MOVE_RIGHT}},
    {  MOD |ALT,          XK_Left,       movestep,          {.i=TWOBWM_MOVE_LEFT}},
    // Move a window slower
    {  MOD |ALT|SHIFT,    XK_Up,       	 movestep,          {.i=TWOBWM_MOVE_UP_SLOW}},
    {  MOD |ALT|SHIFT,    XK_Down,       movestep,          {.i=TWOBWM_MOVE_DOWN_SLOW}},
    {  MOD |ALT|SHIFT,    XK_Right,      movestep,          {.i=TWOBWM_MOVE_RIGHT_SLOW}},
    {  MOD |ALT|SHIFT,    XK_Left,       movestep,          {.i=TWOBWM_MOVE_LEFT_SLOW}},
    // Teleport the window to an area of the screen.
    // Center:
    {  MOD ,              XK_c,          teleport,          {.i=TWOBWM_TELEPORT_CENTER}},
    // Center y:
    {  MOD |SHIFT,        XK_c,          teleport,          {.i=TWOBWM_TELEPORT_CENTER_Y}},
    // Center x:
    {  MOD |CONTROL,      XK_c,          teleport,          {.i=TWOBWM_TELEPORT_CENTER_X}},
    // Top left:
    ...
    {  MOD ,              XK_s,          nextworkspace,     {}},
    {  MOD ,              XK_a,          prevworkspace,     {}},
    // Move to Next/Previous workspace
    {  MOD |SHIFT ,       XK_s,          sendtonextworkspace,{}},
    {  MOD |SHIFT ,       XK_a,          sendtoprevworkspace,{}},
    // Iconify the window
    //{  MOD |SHIFT,        XK_i,          hide,              {}},
    ...
    {  ALT |CONTROL,      XK_Delete,          twobwm_exit,       {.i=0}},
    {  ALT |CONTROL,      XK_Escape,          twobwm_restart,    {.i=0}},
